 ...
 * 清除APP缓存， 主要功能有清除内/外缓存，清除数据库，清除sharedPreference，清除files和清除自定义目录
 * 参考：http://blog.csdn.net/qq_21376985/article/details/51848943
 */
public class ClearDataManagerUtil {
